...
public class Tableur extends JPanel// implements TableModelListener 
{
	...
	public Tableur ( int nbLigne , int type , String[] tableau  , Chargement chargementCreate, String nomPremiereColonne ) 
    {			
		if ( type == 1)
		{
...
//	}
	...
	public String getValue ( Tableur tableau , int i )
	{
		return tableau.getTable().getValueAt(0,i).toString();
	}
	
	public void setValue ( Tableur tableau , int i )
	{
		tableau.getTable().setValueAt(null,0,i);
	}

	public boolean verifLigneComplete ( int numero , Tableur tableau )
	{
	...
	public boolean estComplet ( Tableur tableau )
	{
		boolean estComplet = true;
		JTable table = tableau.getTable();
	...
	public ArrayList<String> listeValeurLigne ( int ligne , Tableur tableau )
	{
