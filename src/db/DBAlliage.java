...
{	
	...
	// Utilisation de la m�thode getAlliageChargementPrecedent ( ailleurs )
	//	1 - Cr�ation d'un chargement 				=> Chargement chargementCreate = new Chargement ( num+1 , tabInfo[0] , .. , ... , 2 , " test" ... );	
	//	2 - Initialisation de la connexion 			=> DBAlliage dbAlliage = new DBAlliage();
	//	3 - Application de la methode ratach�e 		=> dbAlliage.getAlliageChargementPrecedent( chargementCreate );
	...
	// Retourne le couple de cl� ( Alliage , Color )
	...
	// Retourne l'id de l'alliage en fonction du nom pass� en parametre
	...
	// Retourne le nom l'alliage en fonction de l'id pass�e en parametre
