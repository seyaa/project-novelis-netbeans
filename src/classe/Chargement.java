...
public class Chargement 
{
	...
	// M�thode retournant un String
	// Retourne uniquement la valeur de l'attribut nom1 de l'objet cr�e
	...
	// M�thode retournant un entier
	// Retourne uniquement la valeur de l'attribut typeFour de l'objet cr�e
	// => private int typeFour;
	...
	// M�thode retournant un String
	// Retourne la valeur de l'ensemble des attributs de l'objet sous forme d'une grosse chaine d�taill�e
